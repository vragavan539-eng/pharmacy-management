      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 60, animation: 'fadeInUp 0.6s ease forwards' }}>
          <div style={{
            ...
            fontSize: 22, boxShadow: '0 4px 20px rgba(26,107,74,0.4)',
          }}>💊</div>
        ...
        <div style={{ animation: 'fadeInUp 0.6s ease 0.1s forwards', opacity: 0 }}>
          <div style={{
            ...
            fontSize: 12, color: '#4ade80', marginBottom: 24,
          }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 16 }}>
              <label style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.5)', display: 'block', marginBottom: 8, letterSpacing: 0.8 }}>
                EMAIL ADDRESS
              </label>
              <input
          ...
          <div style={{ textAlign: 'center', marginTop: 24 }}>
            ...
            <button
              className="demo-chip"
              onClick={() => setForm({ email: 'admin@pharmacy.com', password: 'password' })}
            >
